...
export default {
  ...
  methods: {
    async fetchData() {
      this.loading = true
      try {
        let response = await this.$store.dispatch('rmh/fetch', { search: this.search, ...this.pagination })
    ...
    async deleteItem (item) {      
      try {
        ...
        let response = await this.$store.dispatch('rmh/destroy', item.id)
        this.snackbar = true
    ...
    async importExcel() {
      ...
      try {
        let response = await this.$store.dispatch('rmh/importExcel', excelFile)
    ...
    async exportExcel() {
      ...
      try {
        let response = await this.$store.dispatch('rmh/exportExcel')
