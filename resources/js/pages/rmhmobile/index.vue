...
export default {
  ...
  methods: {
    async fetchData() {
      this.loading = true
      try {
        let response = await this.$store.dispatch('rmhmobile/fetch', { search: this.search, ...this.pagination })
    ...
    async deleteItem (item) {      
      try {
        ...
        let response = await this.$store.dispatch('rmhmobile/destroy', item.id)
        this.snackbar = true
