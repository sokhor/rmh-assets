<template>
  <v-layout>
    ...
    <!-- <v-dialog v-model="deletedItemDialog" persistent max-width="290" :return-value="45">
      <v-card>
        <v-card-text>Are you sure want to delete?</v-card-text>
        <v-card-actions>
          <v-spacer></v-spacer>
          <v-btn color="error" flat @click="deletedItemDialog = false">No</v-btn>
          <v-btn flat @click="deletedItemDialog = false">Yes</v-btn>
        </v-card-actions>
      </v-card>
    </v-dialog>     -->
