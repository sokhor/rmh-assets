...
export default {
  ...
  methods: {
    async fetchData() {
      this.loading = true
      try {
        let response = await this.$store.dispatch('vidrl/fetch', { search: this.search, ...this.pagination })
    ...
    async deleteItem (item) {      
      try {
        ...
        let response = await this.$store.dispatch('vidrl/destroy', item.id)
        this.snackbar = true
    ...
    async importExcel() {
      ...
      try {
        let response = await this.$store.dispatch('vidrl/importExcel', excelFile)
    ...
    async exportExcel() {
      ...
      try {
        let response = await this.$store.dispatch('vidrl/exportExcel')
